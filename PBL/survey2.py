...
def survey2(app, main_content_rect, step_value_survey):
    ...
    survey1_submit = ctk.CTkButton(app, text="Next", font=ctk.CTkFont(size=20, family="Arial"), fg_color="#0059ff", hover_color="#0041c4", width=200, height=50, corner_radius=10, command=next_step3)
